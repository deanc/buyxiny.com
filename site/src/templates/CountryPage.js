...
const CountryPage = ({ pageContext: { country, type } }) => {
  return (
    <>
          <SEO 
      title={"Find products from your home countries when living in " + capitalize(country)} 
      description={"Living in " + capitalize(country) + "? Find all your home products and where to buy them"} 
      image={ShareImage}
      />
